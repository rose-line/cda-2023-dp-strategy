  ...
  public class Order
  {
    ...
    public decimal GetTax()
    {
      ...
      if (destination == "luxembourg")
      {
        ...
        #region Taxe différente selon type d'article
        //if (destination == ShippingDetails.OriginCountry.ToLowerInvariant())
        //{
        //    decimal totalTax = 0m;
      ...
      if (destination == "belgique")
      {
        switch (ShippingDetails.DestinationState.ToLowerInvariant())
        {
          case "bx": return TotalPrice * 0.095m;
          case "fl": return TotalPrice * 0.04m;
          case "wl": return TotalPrice * 0.045m;
          default: return 0m;
        }
      }
